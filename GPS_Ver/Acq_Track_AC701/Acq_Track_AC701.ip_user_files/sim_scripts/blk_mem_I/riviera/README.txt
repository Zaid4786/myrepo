...
#
# Generated by export_simulation on Thu Feb 16 05:03:14 +0530 2017
#
################################################################################
...
switch to the './blk_mem_I.sh' script.

./blk_mem_I.sh -reset_run
...
./blk_mem_I.sh -noclean_files

For more information on the script, please type './blk_mem_I.sh -help'.
