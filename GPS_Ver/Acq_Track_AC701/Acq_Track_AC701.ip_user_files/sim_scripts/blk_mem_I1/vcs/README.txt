...
#
# Generated by export_simulation on Thu Feb 16 05:03:54 +0530 2017
#
################################################################################
...
switch to the './blk_mem_I1.sh' script.

./blk_mem_I1.sh -reset_run
...
./blk_mem_I1.sh -noclean_files

For more information on the script, please type './blk_mem_I1.sh -help'.
