...
HD_PWD='D:/gps/GPS_Ver/Acq_Track_AC701/Acq_Track_AC701.runs/blk_mem_I1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_I1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_I1.tcl
