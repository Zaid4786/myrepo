...
HD_PWD='D:/gps/GPS_Ver/Acq_Track_AC701/Acq_Track_AC701.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Acq_Track.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_Acq_Track.tcl -notrace
