...
HD_PWD='D:/gps/GPS_Ver/Acq_Track_AC701/Acq_Track_AC701.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Acq_Track.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_Acq_Track.tcl
