...
HD_PWD='/home/zaid/MTP/myrepo/sysgen/netlist/hwcosim/sum_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hwcosim_top_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source hwcosim_top_wrapper.tcl
