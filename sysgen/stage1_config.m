...
function acquire_config(this_block)
  ...
  % Revision History:
  %
  %   07-Mar-2017  (00:52 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     /home/zaid/MTP/myrepo/sysgen/stage1.v
  %
  %
  ...
  this_block.addSimulinkOutport('clkid');
  this_block.addSimulinkOutport('phase1');
  this_block.addSimulinkOutport('phase2');
  this_block.addSimulinkOutport('phase3');
  this_block.addSimulinkOutport('phase4');
  ...
  clkid_port = this_block.port('clkid');
  clkid_port.setType('UFix_32_0');
  phase1_port = this_block.port('phase1');
  phase1_port.setType('UFix_32_0');
  phase2_port = this_block.port('phase2');
  phase2_port.setType('UFix_32_0');
  phase3_port = this_block.port('phase3');
  phase3_port.setType('UFix_32_0');
  phase4_port = this_block.port('phase4');
  phase4_port.setType('UFix_32_0');
